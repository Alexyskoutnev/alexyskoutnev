...
| Project | ⭐ Stars | Stack / Notes |
|---------|:------:|--------------|
| [**TWIN**](https://github.com/Alexyskoutnev/TWIN-ARC-AGI-3) – State-of-the-art agent for ARC-AGI-3: writes each game's world model, then plans inside it | ![Stars](https://img.shields.io/github/stars/Alexyskoutnev/TWIN-ARC-AGI-3?style=social) | Python · LLM Agents · World Models |
